...
class TabletStepsView extends StatelessWidget {
  final List<StepsDataModel> steps;

  const TabletStepsView({super.key, required this.steps});
        ...
        Stack(
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.only(top: useBlueBackground ? 100 : 0),
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: useBlueBackground ? 50 : 0),
                  CustomTextView(
